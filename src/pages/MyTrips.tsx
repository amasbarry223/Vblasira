...
import { Clock, MapPin, ArrowRight, Car, Bike, Star, Shield, TrendingUp, Leaf } from 'lucide-react';
    ...
    <div className="pb-20">
      <div className="container py-4">
        ...
        <div className="mb-4 grid grid-cols-3 gap-2">
          {[
            { icon: Car, value: '2', label: 'Trajets' },
            { icon: TrendingUp, value: '900 F', label: 'Économisés' },
            { icon: Leaf, value: '3 kg', label: 'CO₂ évité' },
              ...
              >
                ...
                {tab === 'upcoming' && booking.status === 'confirmed' && (
                  <div className="mt-3 flex gap-2">
                    <button className="flex-1 rounded-lg bg-primary/10 py-2 text-xs font-medium text-primary">
                      Contacter
                    </button>
                ...
                {tab === 'history' && booking.status === 'completed' && (
                  <button className="mt-3 w-full rounded-lg bg-secondary/20 py-2 text-xs font-medium text-secondary-foreground">
                    ⭐ Laisser un avis
                  </button>
                )}
              </motion.div>

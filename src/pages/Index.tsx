...
import { Shield, Users, Bike, Car, ArrowRight, Star } from 'lucide-react';
...
const features = [
  {
    ...
    desc: 'Carte d\'étudiant obligatoire',
  },
  {
    icon: Users,
    title: 'Frais partagés',
    desc: 'Dès 300 FCFA/trajet',
  },
  {
    icon: Bike,
    title: 'Moto & Voiture',
    desc: 'Choisissez votre mode',
  },
];
...
const Index = () => {
  const popularTrips = mockTrips.slice(0, 3);
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative container py-12 text-center">
          ...
          <motion.div
            ...
            className="mx-auto mb-6 flex max-w-xs justify-around"
          >
            {stats.map((s) => (
        ...
        <div className="grid grid-cols-3 gap-3">
          {features.map((f, i) => (
            <motion.div
              ...
              className="flex flex-col items-center rounded-xl bg-card p-3 text-center shadow-sm border border-border"
            >
      ...
      <section className="container mt-8">
        <div className="rounded-xl bg-gradient-mali p-4 text-center shadow-mali">
          ...
          <p className="text-xs text-primary-foreground/80">
            Chaque membre est vérifié avec sa carte d'étudiant.

...
const TripDetail = () => {
  ...
  const handleConfirm = () => {
    toast.success('🎉 Réservation confirmée !', {
      description: `${trip.departure_name} → ${trip.destination_name} le ${trip.departure_date} à ${trip.departure_time}`,
    });
      ...
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="container space-y-4">
        ...
        <div className="rounded-xl border border-border bg-card p-4">
          ...
          <div className="mb-4">
            ...
            {seats > 1 && (
              <div className="mt-1 text-right text-xs text-muted-foreground">
                Total: <span className="font-semibold text-foreground">{totalPrice} FCFA</span>
              </div>
            )}
          </div>
          ...
          <motion.button
            ...
            className="w-full rounded-xl bg-gradient-mali py-3.5 text-sm font-bold text-primary-foreground shadow-mali"
          >
          ...
          >
            ...
            <div className="mb-4 space-y-2 text-sm">
              <div className="flex justify-between">
                ...
                <span className="font-medium">{trip.departure_name} → {trip.destination_name}</span>
              </div>
              <div className="flex justify-between">
            ...
            <div className="flex gap-3">
              ...
              <motion.button
                ...
                className="flex-1 rounded-xl bg-gradient-mali py-3 text-sm font-bold text-primary-foreground shadow-mali"
              >
                Confirmer
              </motion.button>
            </div>
